...
// [[Rcpp::export]]
SEXP fit_model_BL_aggToTime_internal(int E, int BURN_IN, int n_Data, double a_phi,double b_phi, double a_omega, double b_omega, double a_pi, double b_pi,
                                                 SEXP pis_r, SEXP phi_0_r, SEXP phi_1_r, SEXP lambda_0_r, SEXP lambda_1_r, SEXP V_0_r, SEXP V_1_r, SEXP omega_0_r, SEXP omega_1_r,
                                                 SEXP X_r, SEXP D_r, SEXP Yt_r, SEXP H_r, int K_r,  SEXP sub_size_n_r) {
  ...
  for(itr = 0; itr < E; itr++){
    ...
    // sample pi
    for(i = 0; i < n_Data; i++){
      pis(i) = Rcpp::rbeta(1, count_Yt_1(i)+ a_pi, sub_size_n(i) - count_Yt_1(i)+ b_pi)(0);
    }
